...
import { sampleWithRequiredData } from '../book-copy.test-samples';
...
describe('BookCopy Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, BookCopyComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.bookCopies?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to bookCopyService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getBookCopyIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getBookCopyIdentifier).toHaveBeenCalledWith(entity);
