...
import { EntityArrayResponseType, BookCopyService } from '../service/book-copy.service';
...
export class BookCopyComponent implements OnInit {
  ...
  trackId = (_index: number, item: IBookCopy): number => this.bookCopyService.getBookCopyIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.bookCopies = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IBookCopy[] | null): IBookCopy[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.bookCopyService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
