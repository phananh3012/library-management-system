...
import { sampleWithRequiredData } from '../patron-account.test-samples';
...
describe('PatronAccount Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, PatronAccountComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.patronAccounts?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
