...
export class HoldComponent implements OnInit {
  ...
  delete(hold: IHold): void {
    const modalRef = this.modalService.open(HoldDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.holds = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IHold[] | null): IHold[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.holdService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
