...
class NotificationResourceIT {
    ...
    @Test
    @Transactional
    void getAllNotificationsByPatronAccountIsEqualToSomething() throws Exception {
        ...
        em.flush();
        notification.setPatronAccount(patronAccount);
        notificationRepository.saveAndFlush(notification);
        Long patronAccountId = patronAccount.getId();
        // Get all the notificationList where patronAccount equals to patronAccountId
        defaultNotificationShouldBeFound("patronAccountId.equals=" + patronAccountId);

        // Get all the notificationList where patronAccount equals to (patronAccountId + 1)
        defaultNotificationShouldNotBeFound("patronAccountId.equals=" + (patronAccountId + 1));
    }
